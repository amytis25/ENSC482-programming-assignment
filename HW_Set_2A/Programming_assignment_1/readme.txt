...
The assignment file is called prob1.py and it can be run through terminal using the command "python prob1.py". The results of the visual are also included in the folder labeled as results.png.
